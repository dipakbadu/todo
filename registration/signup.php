...
<html lang="en">
  ...
  <body class="mt-5" style="background-color: cyan;">
    <div class="container">
        <form method="POST" action="../includes/registration-verification.php">
          <div class="form-group">
            <label for="fullname">fullName</label>
            <input type="text" class="form-control" id="fullName" aria-describedby="fullName" placeholder="fullname" name="fullname" />
          </div>
          <div class="form-group">
